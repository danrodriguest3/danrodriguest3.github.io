      ...
      AFRAME.registerComponent('animation-timeline', {
        ...
        init: function () {
          ...
          for (t = 0; t < e.pauseEvents.length; t++)
            this.el.addEventListener(e.pauseEvents[t], this.pauseAnimation);
        },
        play: function () {
          ...
          for (
              ...
              this.timeline = (AFRAME.anime || AFRAME.ANIME).timeline({
                ...
                complete: function () {
                  (s.animationIsPlaying = !1),
                    s.el.emit('animationtimelinecomplete', s.eventDetail);
                },
            ...
            if ('A-TIMELINE-GROUP' !== o.children[t].tagName)
              'A-TIMELINE-ANIMATION' === o.children[t].tagName &&
                (a += this.addAnimationToTimeline(o.children[t], a));
            else {
              for (r = o.children[t], n = 0, e = 0; e < r.children.length; e++)
                (i = this.addAnimationToTimeline(r.children[e], a)),
                  i > n && (n = i);
              a += n;
            }
        },
        addAnimationToTimeline: function (t, e) {
          ...
          if (
            ...
            return (
              console.warn(
                '[animation-timeline] No entities found for select="' + m + '"',
              ),
              0
            );
          for (
            n = parseFloat(t.getAttribute('offset') || 0, 10), l = 0;
            l < s.length;
            l++
          ) {
